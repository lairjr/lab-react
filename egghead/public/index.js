...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        null,
	        this.state.red,
	        _react2.default.createElement(NumInput, { ref: 'red', update: this.update, txt: this.state.txt })
	      );
	    }
	  }]);
	...
	var NumInput = function (_React$Component2) {
	  ...
	  _createClass(NumInput, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', { type: 'range', min: '0', max: '255', onChange: this.props.update });
	    }
	  }]);
